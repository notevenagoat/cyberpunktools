    ...
    return (
      <React.Fragment>
        ...
        <Table striped variant="dark border-danger" >
          ...
          <tbody id="fashionTable">
            {this.seasonsJSX()}
          </tbody>
        </Table>
        <div>
          {/* class="btn btn-dark" */}
          <Button variant="dark m-1" type="button" onClick={this.addHandler} id="add-season">Add season</Button>
          <Button variant="dark" type="button" onClick={this.clearHandler} id="clear-btn">Clear</Button>
        </div>
      </React.Fragment>
    )
  }
